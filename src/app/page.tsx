...
export default function Home() {
  ...
  return (
    <div className="min-h-screen flex flex-col bg-slate-50/50">
      ...
      {/* Hero Section */}
      <section className="relative overflow-hidden pt-12 pb-20 lg:pt-20 lg:pb-28 bg-gradient-to-b from-primary/5 via-slate-50/50 to-slate-50">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div className="space-y-6 text-center lg:text-left">
              ...
              <div className="flex flex-col sm:flex-row items-center justify-center lg:justify-start gap-4 pt-2">
                ...
                <Link href="/register">
                  <Button size="lg" variant="outline" className="w-full sm:w-auto rounded-xl px-8 h-12 text-base">
                    Patient Registration
                  </Button>
                </Link>
              </div>

              <div className="pt-8 grid grid-cols-3 gap-4 border-t border-slate-200/60 max-w-lg mx-auto lg:mx-0">
                <div>
            ...
            <div className="relative mx-auto w-full max-w-md lg:max-w-none">
              <div className="bg-white p-8 rounded-3xl shadow-2xl border border-slate-100 space-y-6">
                <div className="flex items-center gap-4 border-b border-slate-100 pb-6">
                  <div className="h-14 w-14 rounded-2xl bg-emerald-50 text-emerald-600 flex items-center justify-center font-bold text-xl shadow-sm">
                    <Stethoscope className="h-7 w-7" />
                  </div>
                  <div>
                    <h3 className="font-bold text-slate-900 text-lg">Dr. Sarah Jenkins</h3>
        ...
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {features.map((item, idx) => {
              ...
              return (
                <div key={idx} className="bg-slate-50/70 p-6 rounded-2xl border border-slate-100 hover:shadow-lg transition-all duration-300">
