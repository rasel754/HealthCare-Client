  ...
  return (
    <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 space-y-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        {plans.map((p, idx) => (
          <div key={idx} className="bg-white rounded-3xl border border-slate-200 p-8 shadow-sm flex flex-col justify-between space-y-6">
            <div>
            ...
            <Button className="w-full rounded-xl h-11">Subscribe Plan</Button>
          </div>
        ))}
      </div>
    </div>
